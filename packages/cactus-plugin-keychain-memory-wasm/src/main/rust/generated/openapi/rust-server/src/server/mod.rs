...
mod paths {
    ...
    lazy_static! {
        pub static ref GLOBAL_REGEX_SET: regex::RegexSet = regex::RegexSet::new(vec![
            r"^/api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/delete-keychain-entry$",
            r"^/api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/get-keychain-entry$",
            r"^/api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/has-keychain-entry$",
            r"^/api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/set-keychain-entry$"
        ])
        .expect("Unable to create global regex set");
    }
    pub(crate) static ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_DELETE_KEYCHAIN_ENTRY: usize = 0;
    pub(crate) static ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_GET_KEYCHAIN_ENTRY: usize = 1;
    pub(crate) static ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_HAS_KEYCHAIN_ENTRY: usize = 2;
    pub(crate) static ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_SET_KEYCHAIN_ENTRY: usize = 3;
}
    ...
    C: Has<XSpanIdString>  + Send + Sync + 'static
{
        ...
        C: Has<XSpanIdString>  + Send + Sync + 'static
    {
        ...
        match method {
            ...
            // DeleteKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/delete-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_DELETE_KEYCHAIN_ENTRY) => {
                ...
                match result {
                            Ok(body) => {
                                ...
                                let param_delete_keychain_entry_request_v1 = match param_delete_keychain_entry_request_v1 {
                                    Some(param_delete_keychain_entry_request_v1) => param_delete_keychain_entry_request_v1,
            ...
            // GetKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/get-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_GET_KEYCHAIN_ENTRY) => {
                // Body parameters (note that non-required body parameters will ignore garbage
                // values, rather than causing a 400 response). Produce warning header and logs for
                // any unused fields.
                let result = body.into_raw().await;
            ...
            // HasKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/has-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_HAS_KEYCHAIN_ENTRY) => {
                // Body parameters (note that non-required body parameters will ignore garbage
                // values, rather than causing a 400 response). Produce warning header and logs for
                // any unused fields.
                let result = body.into_raw().await;
                match result {
                            Ok(body) => {
                                ...
                                let param_has_keychain_entry_request_v1 = match param_has_keychain_entry_request_v1 {
                                    Some(param_has_keychain_entry_request_v1) => param_has_keychain_entry_request_v1,
                                    None => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
            ...
            // SetKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/set-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_SET_KEYCHAIN_ENTRY) => {
                // Body parameters (note that non-required body parameters will ignore garbage
                // values, rather than causing a 400 response). Produce warning header and logs for
                // any unused fields.
                let result = body.into_raw().await;
            ...
            _ if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_DELETE_KEYCHAIN_ENTRY) => method_not_allowed(),
            _ if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_GET_KEYCHAIN_ENTRY) => method_not_allowed(),
            _ if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_HAS_KEYCHAIN_ENTRY) => method_not_allowed(),
            _ if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_SET_KEYCHAIN_ENTRY) => method_not_allowed(),
...
impl<T> RequestParser<T> for ApiRequestParser {
    fn parse_operation_id(request: &Request<T>) -> Option<&'static str> {
        ...
        match *request.method() {
            // DeleteKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/delete-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_DELETE_KEYCHAIN_ENTRY) => Some("DeleteKeychainEntryV1"),
            // GetKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/get-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_GET_KEYCHAIN_ENTRY) => Some("GetKeychainEntryV1"),
            // HasKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/has-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_HAS_KEYCHAIN_ENTRY) => Some("HasKeychainEntryV1"),
            // SetKeychainEntryV1 - POST /api/v1/plugins/@hyperledger/cactus-plugin-keychain-memory-wasm/set-keychain-entry
            hyper::Method::POST if path.matched(paths::ID_API_V1_PLUGINS_HYPERLEDGER_CACTUS_PLUGIN_KEYCHAIN_MEMORY_WASM_SET_KEYCHAIN_ENTRY) => Some("SetKeychainEntryV1"),
            _ => None,
        }
    }
}
