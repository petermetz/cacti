...
//   watch_blocks_v1_pb,
// } from "@hyperledger/cacti-plugin-ledger-connector-celo";
...
// describe("CeloGrpcSvcOpenApi", () => {
//   const log: Logger = LoggerProvider.getOrCreate({
//     label: "plugin-ledger-connector-celo-grpc-service-test",
//     level: logLevel,
//   });

//   let ledger: CeloTestLedger;
//   let httpServer: http.Server;
//   let grpcServer: grpc.Server;
//   let connector: PluginLedgerConnectorCelo;
//   let grpcClientDefaultSvc: default_service.org.hyperledger.cacti.plugin.ledger.connector.celo.services.defaultservice.DefaultServiceClient;
//   let grpcClientCeloSvc: celo_grpc_svc_streams.org.hyperledger.cacti.plugin.ledger.connector.celo.services.celoservice.CeloGrpcSvcStreamsClient;
...
//     log.info("Start CeloTestLedger...");
//     ledger = new CeloTestLedger({});
//     await ledger.start();
...
//     log.debug("Instantiating PluginLedgerConnectorCelo...");

//     connector = new PluginLedgerConnectorCelo({
//       rpcApiHttpHost,
//       rpcApiWsHost,
//       logLevel,
//       instanceId: uuidv4(),
...
//       new default_service.org.hyperledger.cacti.plugin.ledger.connector.celo.services.defaultservice.DefaultServiceClient(
//         grpcUrl,
...
//     grpcClientCeloSvc =
//       new celo_grpc_svc_streams.org.hyperledger.cacti.plugin.ledger.connector.celo.services.celoservice.CeloGrpcSvcStreamsClient(
//         grpcUrl,
//         grpcChannelCredentials,
//         {
//           "grpc-node.tls_enable_trace": 1,
...
//       new get_block_v1_request_pb.org.hyperledger.cacti.plugin.ledger.connector.celo.GetBlockV1RequestPB(
//         { blockHashOrBlockNumber },
//       );

//     const req1 =
//       new default_service.org.hyperledger.cacti.plugin.ledger.connector.celo.services.defaultservice.GetBlockV1Request(
//         { getBlockV1RequestPB },
//       );
...
//     const res1Promise =
//       new Promise<get_block_v1_response_pb.org.hyperledger.cacti.plugin.ledger.connector.celo.GetBlockV1ResponsePB>(
//         (resolve, reject) => {
...
//               value?: get_block_v1_response_pb.org.hyperledger.cacti.plugin.ledger.connector.celo.GetBlockV1ResponsePB,
//             ) => {
...
//     const stream = grpcClientCeloSvc.WatchBlocksV1(reqMetadata);
...
//             new watch_blocks_v1_request_pb.org.hyperledger.cacti.plugin.ledger.connector.celo.WatchBlocksV1RequestPB();

//           reqUnsubscribe.event =
//             watch_blocks_v1_pb.org.hyperledger.cacti.plugin.ledger.connector.celo.WatchBlocksV1PB.WatchBlocksV1PB_Unsubscribe;
