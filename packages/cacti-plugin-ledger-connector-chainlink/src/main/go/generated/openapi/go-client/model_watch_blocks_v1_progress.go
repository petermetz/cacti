...
func NewWatchBlocksV1Progress(data map[string]interface{}) *WatchBlocksV1Progress {
...
func (o *WatchBlocksV1Progress) GetData() map[string]interface{} {
	if o == nil {
...
func (o *WatchBlocksV1Progress) GetDataOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *WatchBlocksV1Progress) SetData(v map[string]interface{}) {
	o.Data = v
}
