...
export class ChainlinkApiClientOptions extends Configuration {
...
{
  public static readonly CLASS_NAME = "ChainlinkApiClient";
  ...
  public get className(): string {
    return ChainlinkApiClient.CLASS_NAME;
  }

  constructor(public readonly options: ChainlinkApiClientOptions) {
    super(options);
