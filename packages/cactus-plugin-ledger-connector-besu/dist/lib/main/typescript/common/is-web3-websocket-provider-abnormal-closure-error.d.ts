...
export declare const WEB3_CONNECTION_NOT_OPEN_ON_SEND = "connection not open on send()";
/**
 ...
 * ```
 */
export declare function isWeb3WebsocketProviderAbnormalClosureError(err: unknown): err is Error & {
    code: typeof ABNORMAL_CLOSURE;
};
