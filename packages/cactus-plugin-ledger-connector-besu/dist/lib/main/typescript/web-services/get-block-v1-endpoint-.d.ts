...
export declare class GetBlockEndpoint implements IWebServiceEndpoint {
    readonly options: IGetBlockEndpointOptions;
    static readonly CLASS_NAME = "GetBlockEndpoint";
    private readonly log;
    get className(): string;
    constructor(options: IGetBlockEndpointOptions);
    get oasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-besu/get-block"];
    getPath(): string;
