...
export class CeloApiClientOptions extends Configuration {
  readonly logLevel?: LogLevelDesc;
  readonly wsApiHost?: string;
  readonly wsApiPath?: string;
}

export class CeloApiClient
  extends DefaultApi
  implements ISocketApiClient<WatchBlocksV1Progress>
{
  public static readonly CLASS_NAME = "CeloApiClient";
  ...
  public get className(): string {
    return CeloApiClient.CLASS_NAME;
  }

  constructor(public readonly options: CeloApiClientOptions) {
    super(options);
