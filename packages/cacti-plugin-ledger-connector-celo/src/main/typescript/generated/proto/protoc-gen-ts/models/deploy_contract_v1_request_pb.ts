 ...
 * source: models/deploy_contract_v1_request_pb.proto
 * git: https://github.com/thesayyn/protoc-gen-ts */
import * as dependency_1 from "./../google/protobuf/any";
import * as dependency_2 from "./web3_signing_credential_private_key_hex_pb";
import * as pb_1 from "google-protobuf";
export namespace org.hyperledger.cacti.plugin.ledger.connector.celo {
    export class DeployContractV1RequestPB extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            ...
            web3SigningCredential?: dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB;
            bytecode?: string;
            gas?: number;
            gasPrice?: string;
            timeoutMs?: number;
        ...
        get chainId() {
            return pb_1.Message.getFieldWithDefault(this, 201929661, 0) as number;
        }
        set chainId(value: number) {
            pb_1.Message.setField(this, 201929661, value);
        }
        get contractName() {
        ...
        get web3SigningCredential() {
            return pb_1.Message.getWrapperField(this, dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB, 451211679) as dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB;
        }
        set web3SigningCredential(value: dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB) {
        ...
        static fromObject(data: {
            ...
            web3SigningCredential?: ReturnType<typeof dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB.prototype.toObject>;
            bytecode?: string;
            gas?: number;
            gasPrice?: string;
            timeoutMs?: number;
        }): DeployContractV1RequestPB {
            const message = new DeployContractV1RequestPB({});
            ...
            if (data.web3SigningCredential != null) {
                message.web3SigningCredential = dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB.fromObject(data.web3SigningCredential);
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.chainId != 0)
                writer.writeFloat(201929661, this.chainId);
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeployContractV1RequestPB {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new DeployContractV1RequestPB();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 201929661:
                        message.chainId = reader.readFloat();
                        break;
                    case 328784197:
                    ...
                    case 336490508:
                        ...
                        break;
                    case 451211679:
                        reader.readMessage(message.web3SigningCredential, () => message.web3SigningCredential = dependency_2.org.hyperledger.cacti.plugin.ledger.connector.celo.Web3SigningCredentialPrivateKeyHexPB.deserialize(reader));
                        break;
                    case 256554254:
        ...
        static deserializeBinary(bytes: Uint8Array): DeployContractV1RequestPB {
            return DeployContractV1RequestPB.deserialize(bytes);
        }
    }
}
